...
for idx, url in enumerate(urls):
    try:
        ...
        product_data["about_this_item"] = [item.text.strip() for item in about_section.find_all("span", {"class": "a-list-item"})] if about_section else None
        ...
        product_data["reviews"] = "; ".join(reviews) if reviews else "No reviews available"
        ...
        with open(output_file, "w", newline="", encoding="utf-8") as csvfile:
            ...
            writer.writerow([
                ...
                "; ".join(product_data["about_this_item"] if product_data["about_this_item"] else []),
